// Agregar un partido al historial
...
// Ruta para obtener los cruces entre dos equipos de dos usuarios
app.post('/api/getCruces', async (req, res) => {
...
app.post('/api/getCrucesPorUsuarios', async (req, res) => {
